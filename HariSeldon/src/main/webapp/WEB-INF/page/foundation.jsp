...
<link rel="stylesheet"  href="res/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
<link rel="stylesheet"	href="res/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
...
<body  class="hold-transition skin-blue sidebar-mini">
	<header class="main-header">
		<!-- Logo -->
		<a href="/foundation" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
			<span class="logo-mini"><b>H</b>Sdn</span> <!-- logo for regular state and mobile devices -->
			<span class="logo-lg"><b>Hari</b>Seldon</span>
		</a>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown user user-menu"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"> <img
							src="res/dist/img/user2-160x160.jpg" class="user-image"
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header"><img
								src="res/dist/img/user2-160x160.jpg" class="img-circle"
								alt="User Image">
								...
								<div class="box-body">
									...
									<div class="direct-chat-messages">
										...
										<div class="direct-chat-msg">
											...
											<!-- /.direct-chat-info -->
											<img class="direct-chat-img" src="res/dist/img/user1-128x128.jpg"
										...
										<div class="direct-chat-msg right">
											...
											<!-- /.direct-chat-info -->
											<img class="direct-chat-img" src="res/dist/img/user3-128x128.jpg"
												alt="message user image">
											<!-- /.direct-chat-img -->
							...
							<ul class="products-list product-list-in-box">
								<li class="item">
									<div class="product-img">
										<img src="res/dist/img/default-50x50.gif" alt="Product Image">
									</div>
