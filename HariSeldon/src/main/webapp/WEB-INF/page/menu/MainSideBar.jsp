		...
		<section class="sidebar">
			...
			<div class="user-panel">
				<div class="pull-left image">
					<img src="res/dist/img/user2-160x160.jpg" class="img-circle"
						alt="User Image">
				</div>
			...
			<ul class="sidebar-menu">
				...
				<li class="treeview"><a href="#"> <i
						class="fa fa-dashboard"></i> <span>Resource</span> <span
						class="pull-right-container"> <i
							class="fa fa-angle-left pull-right"></i>
					</span>
				</a>
					<ul class="treeview-menu">
						<li><a href="host.do"><i class="fa fa-circle-o"></i>Host</a></li>
						<li class="active"><a href="404"><i	class="fa fa-circle-o"></i> Cluster</a></li>
						<li class="active"><a href="index2.html"><i	class="fa fa-circle-o"></i> Resource Pool</a></li>
					</ul></li>
				<li class="treeview"><a href="#"> <i class="fa fa-files-o"></i>
						<span>Services</span> <span class="pull-right-container">
							<span class="label label-primary pull-right">4</span>
					</span>
				</a>
					<ul class="treeview-menu">
						<li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> HDFS</a></li>
						<li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Yarn</a></li>
						<li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i> Zookeeper</a></li>
						<li><a href="pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i> HBase</a></li>
						<li><a href="pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i> Impala</a></li>
						<li><a href="pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i> Spark]</a></li>
					</ul></li>
				<li><a href="pages/widgets.html"> <i class="fa fa-th"></i>
						<span>Monitor</span> <span class="pull-right-container"> <small
							class="label pull-right bg-green">new</small>
					</span>
				</a></li>
				<li class="treeview"><a href="#"> <i
						class="fa fa-pie-chart"></i> <span>Monitor</span> <span
						class="pull-right-container"> <i
							class="fa fa-angle-left pull-right"></i>
					</span>
				</a>
					<ul class="treeview-menu">
						<li><a href="pages/charts/chartjs.html"><i
								class="fa fa-circle-o"></i> MR Jobs</a></li>
						<li><a href="pages/charts/morris.html"><i
								class="fa fa-circle-o"></i> Yarn App</a></li>
						<li><a href="pages/charts/flot.html"><i
								class="fa fa-circle-o"></i> Spark Jobs</a></li>
						<li><a href="pages/charts/inline.html"><i
								class="fa fa-circle-o"></i> Impala Jobs</a></li>
					</ul></li>
				<li class="treeview"><a href="#"> <i class="fa fa-laptop"></i>
						<span>Logs</span> <span class="pull-right-container">
